...
import { MonitorUp, Tv2, Users, AlertCircle, RefreshCw, Camera } from 'lucide-react';
              ...
              <div className="flex items-center space-x-4 sm:space-x-6">
                {mode === 'host' && (
                  <>
                    ...
                    <button
                      onClick={onExit}
                      className="rounded-xl border border-slate-200 bg-white px-5 py-2.5 text-sm font-bold text-slate-600 transition-colors hover:bg-slate-50 shadow-sm hidden sm:block"
                ...
                <button
                  onClick={stopSession}
                  className="rounded-xl bg-red-50 border border-red-100 px-6 py-2.5 text-sm font-bold text-red-600 transition-colors hover:bg-red-100 shadow-sm"
                >
                  TERMINATE
                </button>
              </div>
